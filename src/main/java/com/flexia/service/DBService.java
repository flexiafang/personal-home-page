...
import com.flexia.bean.*;
import com.flexia.dao.*;
...
public class DBService {
    ...
    private static BaseDao<User> userDao = new UserDaoImpl();
    private static BaseDao<Skill> skillDao = new SkillDaoImpl();
    private static BaseDao<Specialty> specialtyDao = new SpecialtyDaoImpl();
    private static BaseDao<Work> workDao = new WorkDaoImpl();
    private static BaseDao<Edu> eduDao = new EduDaoImpl();
